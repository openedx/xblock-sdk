...
coverage: clean ## generate and view HTML coverage report
	pip3 install -qr requirements/local.txt --exists-action w ## Install sample xblocks
...
requirements: ## install development environment requirements
	pip3 install -qr requirements/dev.txt --exists-action w
	pip3 install -qr requirements/local.txt --exists-action w
